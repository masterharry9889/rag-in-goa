        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400 drop-shadow-sm">
              Speech-to-Text <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-brand-light drop-shadow-[0_0_15px_rgba(187,220,18,0.2)]">Providers</span>
            </h1>
            <p className="text-gray-400 text-lg font-light">Configure your API keys and models for STT services securely.</p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-brand-main/20 to-transparent opacity-50 rounded-bl-full -z-10"></div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full appearance-none bg-[#0f1115] border border-[#272b36] rounded-xl px-5 py-4 text-white focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-transparent transition-all shadow-inner cursor-pointer"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0f1115] border border-[#272b36] rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-transparent transition-all shadow-inner"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0f1115] border border-[#272b36] rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-transparent transition-all shadow-inner"
                    placeholder="e.g. sarvam-1, eleven_multilingual_v2"
                  />
                </div>
                ...
                {message && (
                  <motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className={`p-4 rounded-xl text-sm font-medium backdrop-blur-md ${message.includes('success') ? 'bg-brand-dark/20 text-brand-light border border-brand-main/30' : 'bg-red-500/20 text-red-300 border border-red-500/30'}`}
                  >
                    {message}
                  </motion.div>
                )}
            ...
            <div className="lg:col-span-7">
              <h2 className="text-2xl font-bold mb-8 text-gray-400 pl-4 border-l-4 border-brand-accent">Configured Providers</h2>
                ...
                <div className="grid sm:grid-cols-2 gap-6 items-start">
                  <AnimatePresence>
                    {configuredProviders.map((provider, idx) => (
                      ...
                      >
                        <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-brand-accent to-brand-light"></div>
                        
                        <div className="flex justify-between items-start mb-6">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-brand-accent/20 flex items-center justify-center text-brand-light border border-brand-accent/30">
                          ...
                          <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button
                              ...
                              className="p-2.5 bg-brand-accent/10 text-brand-light hover:bg-brand-accent/20 rounded-xl border border-transparent hover:border-brand-accent/20 transition-all active:scale-95"
                              title="Edit Provider"
                            >
                              <Edit2 size={16} />
                            </button>
